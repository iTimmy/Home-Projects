...
import com.kz.assontrack.dto.Course;
import com.kz.assontrack.dto.Student;
...
public class CourseDaoDB implements CourseDao {
    ...
    public void updateCourse(Course course) {
        ...
        jdbc.update(UPDATE_COURSE, course.getName(), course.getDescription(), course.getTeacher().getId(),
                course.getId());
